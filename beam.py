...
crack_model = torchvision.models.shufflenet_v2_x1_5(weights='IMAGENET1K_V1')
...
if torch.cuda.is_available():
    crack_model.cuda()
crack_model.load_state_dict(torch.load('./crack_classification/model.pth', map_location=device))
crack_model.eval()
